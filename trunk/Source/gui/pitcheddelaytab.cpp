...
void PitchedDelayTab::paint (Graphics& g)
{
    ...
    g.drawRect (2, 25, getWidth() - 4, 80, 1);

    g.setColour (Colour (0x80000000));
    g.drawRect (2, 115, getWidth() - 4, 80, 1);
...
{
    sDelay->setBounds (110, 30, getWidth() - 230, 20);
    label->setBounds (5, 30, 100, 20);
    cbSync->setBounds (getWidth() - 110, 30, 100, 20);
    sPitch->setBounds (110, 55, getWidth() - 230, 20);
    tbPostPitch->setBounds (getWidth() - 110, 80, 100, 20);
    sFeedback->setBounds (110, 80, getWidth() - 230, 20);
    label3->setBounds (5, 80, 100, 20);
    sFreq->setBounds (110, 120, getWidth() - 250, 20);
    label4->setBounds (5, 120, 100, 20);
    tbSemitones->setBounds (getWidth() - 110, 55, 100, 20);
    sQfactor->setBounds (110, 145, getWidth() - 250, 20);
    label5->setBounds (5, 145, 100, 20);
    cbFilter->setBounds (getWidth() - 130, 145, 120, 20);
    label6->setBounds (getWidth() - 130, 120, 120, 20);
    ...
    internalPath1.lineTo ((float) (getWidth() - 4), 101.0f);
    internalPath1.lineTo ((float) (getWidth() - 111), 101.0f);
    internalPath1.lineTo ((float) (getWidth() - 111), 77.0f);
    internalPath1.lineTo (4.0f, 77.0f);
...
double PitchedDelayTab::getSliderDelaySeconds()
{
	...
	case 1: // seconds
		return val;
	case 2: // 1/2
		return 2*timePerQuarter * val;
		//val = (0.5 * seconds / timePerQuarter );
	case 3: // 1/2T
		return 4/3. * timePerQuarter * val;
		//val = (2/3 * seconds / timePerQuarter );
	case 4: // 1/4
		return timePerQuarter * val;
		//val = (seconds / timePerQuarter);
	case 5: // 1/4T
		return 2/3. * timePerQuarter * val;
		//val = (4/3* seconds / timePerQuarter );
	case 6: // 1/8
		return 0.5 * timePerQuarter * val;
		//val = (2 * seconds / timePerQuarter );
	case 7: // 18T
		return 1/3. * timePerQuarter * val;
		//val = (seconds / timePerQuarter );
	case 8: // 16
		return 0.25 * timePerQuarter * val;
...
<JUCER_COMPONENT documentType="Component" className="PitchedDelayTab" componentName=""
                 ...
                 fixedSize="1" initialWidth="500" initialHeight="260">
  <BACKGROUND backgroundColour="ffffff">
    <RECT pos="0 0 0M 0M" fill="linear: 0 0, 0 0R, 0=ffc0c0c0, 1=ff707070"
          hasStroke="0"/>
    <RECT pos="2 25 4M 80" fill="solid: ffffff" hasStroke="1" stroke="1, mitered, butt"
          strokeColour="solid: 80000000"/>
    <RECT pos="2 115 4M 80" fill="solid: ffffff" hasStroke="1" stroke="1, mitered, butt"
          strokeColour="solid: 80000000"/>
    <PATH pos="0 0 100 100" fill="solid: 40ffffff" hasStroke="1" stroke="1, mitered, butt"
          strokeColour="solid: ff000000" nonZeroWinding="1">s 4 53 l 4R 53 l 4R 101 l 111R 101 l 111R 77 l 4 77 x</PATH>
  </BACKGROUND>
  <SLIDER name="DelaySlider" id="e11598fe9ccb5d4" memberName="sDelay" virtualName=""
          explicitFocusOrder="0" pos="110 30 230M 20" tooltip="Delay time"
  ...
  <LABEL name="new label" id="17c1100985312b05" memberName="label" virtualName=""
         explicitFocusOrder="0" pos="5 30 100 20" edTextCol="ff000000"
  ...
  <COMBOBOX name="SyncComboBox" id="e67496d5c14bd1b4" memberName="cbSync"
            virtualName="" explicitFocusOrder="0" pos="110R 30 100 20" tooltip="Quantisation"
            editable="0" layout="33" items="seconds&#10;1/2&#10;1/2T&#10;1/4&#10;1/4T&#10;1/8&#10;1/8T&#10;1/16"
            textWhenNonSelected="" textWhenNoItems="(no choices)"/>
  <SLIDER name="PitchSlider" id="4f81ab45b18aa5d8" memberName="sPitch"
          virtualName="" explicitFocusOrder="0" pos="110 55 230M 20" tooltip="Pitch-Shift"
  ...
  <TOGGLEBUTTON name="PostPitchButton" id="69444009b8d90dd7" memberName="tbPostPitch"
                virtualName="" explicitFocusOrder="0" pos="110R 80 100 20" tooltip="When checked, pitch is applied only before feedback loop. Otherwise the feedback will be pitched to. Pitching inside the feedback results in a minimum delay time."
  ...
  <SLIDER name="FeedbackSlider" id="8a1d019dd2ee110e" memberName="sFeedback"
          virtualName="" explicitFocusOrder="0" pos="110 80 230M 20" tooltip="Delay feedback"
  ...
  <LABEL name="new label" id="bb4ca75073b47191" memberName="label3" virtualName=""
         explicitFocusOrder="0" pos="5 80 100 20" edTextCol="ff000000"
  ...
  <SLIDER name="FrequencySlider" id="6df9989dcc0448f2" memberName="sFreq"
          virtualName="" explicitFocusOrder="0" pos="110 120 250M 20" tooltip="Filter in feedback loop frequency"
  ...
  <LABEL name="new label" id="42a436310bac269c" memberName="label4" virtualName=""
         explicitFocusOrder="0" pos="5 120 100 20" edTextCol="ff000000"
  ...
  <TOGGLEBUTTON name="SemitonesButton" id="72b923a08fbb4de8" memberName="tbSemitones"
                virtualName="" explicitFocusOrder="0" pos="110R 55 100 20" tooltip="Pitch only in semitones"
  ...
  <SLIDER name="QSlider" id="2b1bb8d3200587d7" memberName="sQfactor" virtualName=""
          explicitFocusOrder="0" pos="110 145 250M 20" tooltip="Filter in feedback loop Q-factor"
  ...
  <LABEL name="new label" id="560dc0f41a0d4db6" memberName="label5" virtualName=""
         explicitFocusOrder="0" pos="5 145 100 20" edTextCol="ff000000"
  ...
  <COMBOBOX name="FilterTypeComboBox" id="dc2f5f9efc6074ec" memberName="cbFilter"
            virtualName="" explicitFocusOrder="0" pos="130R 145 120 20" tooltip="Filter Type. Maximum filter gain is limited to 0 dB to avoid feedback oscillation."
            editable="0" layout="33" items="Off&#10;Lowpass&#10;Highpass&#10;Lowshelf&#10;Highshelf&#10;Bell&#10;Bandpass&#10;Notch"
            textWhenNonSelected="" textWhenNoItems="(no choices)"/>
  <LABEL name="new label" id="c7401e46e71bdc1d" memberName="label6" virtualName=""
         explicitFocusOrder="0" pos="130R 120 120 20" edTextCol="ff000000"
  ...
  <SLIDER name="GainSlider" id="50aec1bc77928637" memberName="sGain" virtualName=""
          explicitFocusOrder="0" pos="110 170 250M 20" tooltip="Filter in feedback loop gain (where available)"
  ...
  <LABEL name="new label" id="4ec97e73ed4eee4f" memberName="label7" virtualName=""
         explicitFocusOrder="0" pos="5 170 100 20" edTextCol="ff000000"
